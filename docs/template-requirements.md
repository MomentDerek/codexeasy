...
App scaffolding is created with `bun create tauri-app@latest -- --template react-ts`, producing a basic directory structure. Other directories are added to provide a basic structure:
