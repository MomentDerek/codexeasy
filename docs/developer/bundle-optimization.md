...
bunx webpack-bundle-analyzer dist/assets/index-*.js
```
...
bun add react@<version> react-dom@<version>
```
...
Remember: **Measure before optimizing**. Use `bun run build:analyze` to understand your bundle before making changes.
